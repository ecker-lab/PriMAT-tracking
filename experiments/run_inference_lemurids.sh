...
do
    ...
    for model in large_scale_para_test4 #new_labeling_0.2 #new_labeling_0.3 new_labeling_0.4 new_labeling_0.3_half_lr new_labeling_0.3_double_lr # #model #hand_picked #model #
    do
...
#../exp/mot/lemur_ids_head/model_32.pth\ # for lemur_ids_head
#../exp/id/batch_id_training/"$model"/model_checkpoint_"$i".pth\
#additional 22
#base 12
#cleaned 28
...
python demo.py mot  --load_tracking_model ../models/hrnet32_lemur_sep22.pth\
                    --load_id_model ../models/georg_model1/"$model".pth\
                    --conf_thres 0.02\
                    --det_thres 0.6\
                    --new_overlap_thres 0.85\
                    --sim_thres 0.8\
                    --input_video /usr/users/agecker/datasets/lemur_ids/alpha_ID_validation_snippets/"$vid".mp4\
                    --output_root ../videos/georg/"$model"/\
                    --output_name "$vid"\
                    --store_opt\
                    --line_thickness 2\
                    --arch hrnet_32\
