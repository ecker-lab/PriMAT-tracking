...
if __name__ == '__main__':
    data_val = '/local_datasets/crowdhuman/images/val'
    label_val = '/local_datasets/crowdhuman/labels_with_ids/val'
    ann_val = '/local_datasets/crowdhuman/annotation_val.odgt'
    data_train = '/local_datasets/crowdhuman/images/train'
    label_train = '/local_datasets/crowdhuman/labels_with_ids/train'
    ann_train = '/local_datasets/crowdhuman/annotation_train.odgt'
