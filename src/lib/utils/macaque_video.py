...
class MacaqueVideos(_BaseDataset):
    """Dataset class for Macaque Videos"""
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'CLASSES_TO_EVAL': ['macaque'],  # Valid: ['pedestrian']
            'BENCHMARK': 'macaque_videos_eval',  # Valid: 'MOT17', 'MOT16', 'MOT20', 'MOT15'
    ...
    def __init__(self, config=None):
        ...
        # Get classes to eval
        self.valid_classes = ['macaque']
        self.class_list = [cls.lower() if cls.lower() in self.valid_classes else None
                           for cls in self.config['CLASSES_TO_EVAL']]
        if not all(self.class_list):
            raise TrackEvalException('Attempted to evaluate an invalid class. Only macaque class is valid.')
        self.class_name_to_class_id = {'macaque': 1}
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        for t in range(raw_data['num_timesteps']):
            ...
            # Evaluation is ONLY valid for macaque class
