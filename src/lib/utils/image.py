...
def random_affine(img, targets=None, degrees=(-10, 10), translate=(.1, .1), scale=(.9, 1.1), shear=(-2, 2),
    ...
    #adding this while loop to ensure that not all the boxes are cut out of the images with the augmentation
    while flag:
        # Rotation and Scale
        R = np.eye(3)
        ...
        return imw
        # FIXME alternative to while loop :: return indexes of deleted targets that are not in frame anymore to also delete them in the data
