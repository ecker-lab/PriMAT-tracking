...
def draw_boxes_on_frames(video_path, bounding_boxes, names, output_path='../videos/lemur_ids/alpha_ind1/output.mp4'):
...
if __name__ == "__main__":
    # Path to video file
    video_path = '../datasets/lemur_videos_eval/Videos/alpha_ind1.mp4'

    # Path to bounding boxes file
    bounding_boxes_path = '../videos/lemur_ids/alpha_ind1/results-out.txt'
