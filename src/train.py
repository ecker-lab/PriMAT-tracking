...
def main(opt):
    ...
    model = create_model(opt.arch, opt.heads, opt.head_conv, num_classes=opt.num_classes, cat_spec_wh=opt.cat_spec_wh, clsID4Pose=opt.clsID4Pose, conf_thres=opt.conf_thres)
